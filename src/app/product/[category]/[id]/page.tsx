...
export default function ProductPage({ params }: NextJS.PageProps) {
  ...
  if (!product) {
    notFound();
    // This return is never reached but helps TypeScript understand that product is not null below
    return null;
  }
  ...
  const relatedProducts = getRelatedProducts(product.id, 4).map(relatedProduct => ({
    ...
    <div className="container mx-auto px-4 py-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        <div>
          ...
          <p className="text-2xl text-gold font-semibold mb-6">{formatPrice(price)}</p>
